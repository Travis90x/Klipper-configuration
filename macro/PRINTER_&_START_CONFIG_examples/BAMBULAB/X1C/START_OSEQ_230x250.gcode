;===== machine: X1 + OSEQ 250x230 by TS90X - START GCODE ====================
;===== date: 20251110 =====================
;===== start printer sound ================
M17
M400 S1
...
G91 ; relative mode
G1 X-63 F20000  ; run snake pattern from top back to front, run at max acceleration.
...
G1 Z10 F1200 ; Make sure we don't hit the bed during wiping passes
G0 X135 Y128 F20000  ; move to exposed steel surface edge
...
G1 F30000
G1 X128 Y128
G28 Z ; home again after hard wipe mouth
G28 X
...
;G1 X128 Y128 F24000
;G28 Z P0 ; re-homing Z
; M972 S5 P0  ; detect build plate?
;G1 Z10 F1200
;G1 X230 Y15 F24000
...
G29.1 Z{-0.04} ; for Textured Cool Plate
{endif}

{if (curr_bed_type=="High Temp Plate")}
G29.1 Z{+0.02} ; for High Temp Plate
{endif}
